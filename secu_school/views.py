...
def aanbod():
    ...
    if result > 0:
        return render_template('home/aanbod.html', richtingen = richtingen)
    else:
...
def wieiswie():
    ...
    if result > 0:
        return render_template('home/wieiswie.html', leraren = leraren)
    else:
        msg = 'Geen leerkrachten in het systeem.'
        return render_template('home/wieiswie.html', msg=msg)
    cur.close()
...
def intranet():
    ...
    return render_template('dashboard/intranet.html', richtingen=richtingen, leraren=leraren, klassen=klassen)
    cur.close()
